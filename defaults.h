...
#ifdef DEFAULTS_PCBOT
  // Description: PCBot CNC mill with four NEMA 17 stepper motors, driven by Mega2560+RAMPS
  #define MICROSTEPS_XY 16
  #define STEP_REVS_XY 200
  #define MM_PER_REV_XY (2.5*16) // 2.5mm belt pitch, 16 pulley teeth
  #define MICROSTEPS_Z 16
  #define STEP_REVS_Z 200
  #define MM_PER_REV_Z 2.0 // 2.0 mm/rev leadscrew
  #define DEFAULT_X_STEPS_PER_MM (MICROSTEPS_XY*STEP_REVS_XY/MM_PER_REV_XY)
  #define DEFAULT_Y_STEPS_PER_MM (MICROSTEPS_XY*STEP_REVS_XY/MM_PER_REV_XY)
  #define DEFAULT_Z_STEPS_PER_MM (MICROSTEPS_Z*STEP_REVS_Z/MM_PER_REV_Z)
  #define DEFAULT_X_MAX_RATE 6000.0 // mm/min
